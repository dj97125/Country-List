 ...
 */
public abstract class Hilt_FragmentCountriesList extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentCountriesList() {
    super();
  }

  Hilt_FragmentCountriesList(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentCountriesList_GeneratedInjector) this.generatedComponent()).injectFragmentCountriesList(UnsafeCasts.<FragmentCountriesList>unsafeCast(this));
    }
  }
